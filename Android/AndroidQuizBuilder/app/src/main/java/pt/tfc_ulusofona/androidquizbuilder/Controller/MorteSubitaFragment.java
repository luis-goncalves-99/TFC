...
import pt.tfc_ulusofona.androidquizbuilder.helpers.RankingMorteSubitaLoader;

public class MorteSubitaFragment extends Fragment implements LoaderManager.LoaderCallbacks<ArrayList<Questionario>>{
    ...
    private String modo = "morte_subita";




    public MorteSubitaFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_morte_subita, container, false);
    ...
    public Loader<ArrayList<Questionario>> onCreateLoader(int i, @Nullable Bundle bundle) {
        return new RankingMorteSubitaLoader(getContext(), URL_ADRESS_QUESTIONARIO,URL_ADRESS_RANKINGS, URL_ADRESS_UTILIZADORES, modo);
    }

    @Override
    public void onLoadFinished(@NonNull Loader<ArrayList<Questionario>> loader, ArrayList<Questionario> questionarios) {
        this.questionarios = questionarios;
        ListView lista = (ListView) getView().findViewById(R.id.lista_morte_subita);
